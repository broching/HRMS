...
// Up to `max` receipt attachments for a claim. Supports picking files
// (images/PDF) and taking a photo directly via the device camera. Uploads each
// file to Convex storage and reports the resulting storage ids upward.
    ...
    <div className="grid gap-2">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        >
          ...
          {required && value.length === 0 ? "Add receipt (required)" : "Add file"}
        </Button>
        <Button
          type="button"
          variant="outline"

...
const CATALOG: SearchEntry[] = [
  ...
  { label: "Org Structure", context: "HR Lounge", href: "/hr-lounge/org-settings?tab=structure", icon: IconSitemap, permission: "employees:manage", keywords: ["departments", "teams", "positions", "offices", "hierarchy"] },
  { label: "Organization Settings", context: "HR Lounge", href: "/hr-lounge/org-settings", icon: IconBuildingCog, permission: "org:manage", keywords: ["logo", "locale", "name", "org profile", "currency", "roles", "permissions"] },
